...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
    ...
    public void periodic() {
        ...
        if (mapleSimSwerveDrivetrain != null) {
            ...
            DogLog.log("Drive/SimulationPose", simPose);
            if (robotBumpSim != null) {
                var fieldSpeeds = mapleSimSwerveDrivetrain.mapleSimDrive.getDriveTrainSimulatedChassisSpeedsFieldRelative();
                var simPose3d = robotBumpSim.update(simPose, fieldSpeeds, 5);
                if (robotBumpSim.isOnRamp()) {
                    mapleSimSwerveDrivetrain.mapleSimDrive.setSimulationWorldPose(robotBumpSim.getSimWorldPose(simPose));
                }
                DogLog.log("Drive/SimulationPose3d", simPose3d);
            }
        }
    }
