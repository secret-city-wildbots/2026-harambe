            ...
            SimulatedArena.getInstance()
                .addGamePieceProjectile(new RebuiltFuelOnFly(
                    ...
                    Units.MetersPerSecond
                        .of(ShotPredictor.getShotVel(drivetrain.getSimulatedDriveTrainPose().getTranslation(),
                            drivetrain.getDriveTrainSimulatedChassisSpeedsFieldRelative())), // initial velocity, in m/s
