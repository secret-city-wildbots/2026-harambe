...
export default function () {
    ...
    const allTabs = useMemo(() => [{title: "Checklist",content: (<Container><div class="row"><Checklist ></Checklist></div></Container>)},{title: "TeleOp",content: (<Container><div class="row"><div class="col-2 column"><div class="column-item bubble"><FieldMap socket={socket} id={4} ></FieldMap></div></div><div class="col-6 column"><DashboardSubRow><div class="bubble"><CameraFeed port={11} ></CameraFeed></div><div class="bubble"><CameraFeed port={12} ></CameraFeed></div></DashboardSubRow><DashboardSubRow><div class="bubble"><CameraFeed port={13} ></CameraFeed></div><div class="bubble"><CameraFeed port={14} ></CameraFeed></div></DashboardSubRow></div><div class="col-4 column"><div class="column-item bubble"><AutoChooser socket={socket} id={5} autos={["Nothing","SMR 1","EventTest","Awesome","L Trench 2 Dip","R Trench 2 Dips + Outpost","Simple Left"]} ></AutoChooser></div><div class="column-item bubble"><Overrides socket={socket} columns={2} id={6} switches={[{ label: "Limelight PowerSaver"},{ label: "Disable Camera Feeds"},{ label: "CompMode"},{ label: "Disable Shot Smoothing"},{ label: "Always Aim at Hub"},{ label: "Disable Shoot Safeties"}]} ></Overrides></div></div></div></Container>)},{title: "Subsystems",content: (<Container><div class="row"><div class="col-4 column"><div class="column-item bubble"><SwerveModules socket={socket} id={7} ></SwerveModules></div><div class="column-item bubble"><SystemsCheck socket={socket} id={8} ></SystemsCheck></div></div><div class="col-3 column"><div class="column-item bubble"><NumberDisplay socket={socket} label={"BPS: "} id={9} ></NumberDisplay></div></div><div class="col-5 column"><DashboardSubRow><div class="bubble"><SimpleSubsystem socket={socket} name={"Shooter"} id={10} velocity ></SimpleSubsystem></div><div class="bubble"><SimpleSubsystem socket={socket} name={"Intake"} unit={"rps"} id={11} absolute ></SimpleSubsystem></div></DashboardSubRow><DashboardSubRow><div class="bubble"><SimpleSubsystem socket={socket} name={"Transfer"} id={12} velocity ></SimpleSubsystem></div><div class="bubble"><SimpleSubsystem socket={socket} name={"Indexer"} id={13} velocity ></SimpleSubsystem></div></DashboardSubRow></div></div></Container>)},], []);
